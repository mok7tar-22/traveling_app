...
const tripsData =  [
  Trip(
    ...
    program: [
      'وصول و استقبال بمطار- الانتقال بالأتوبيسات المكيفة للفندق – فى المساء التوجه الى الباخره العائمه للعشاء',
      'ستيقاظ – إفطار- التوجه بالأتوبيسات المكيفة لزيارة منطقه',
      'استيقاظ – إفطار- – ألتوجه ألى ألمطار وألعودة بالسلامة ألى أرض ألوطن',
    ],
    isInSummer: false,
    isForFamilies: true,
    isInWinter: true,
